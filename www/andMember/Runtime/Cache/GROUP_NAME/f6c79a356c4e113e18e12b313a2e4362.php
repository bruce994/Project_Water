                             ...
                             <td data-title="兑换水量/毫升">
                              ...
                              <td data-title="操作">
                                ...
                                <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal<?php echo ($vo["oid"]); ?>"><i class="fa fa-fw fa-qrcode"></i></a> 
                                 ...
                                 <?php if(($vo["state"]) == "0"): ?>| <a href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="msgBox('<?php echo U("Shop/delete",array("id"=>$vo['oid'],"ajax"=>"1"));?>','GET','json','','<?php echo U("Shop/index",array("typeid"=>192));?>',true,'确定删除？');"><i class="fa fa-fw fa-remove"></i></a><?php endif; ?>

                                  <?php  if($vo['state']!="0" && $vo['receipt']=="0"){ ?>                            
                                   | <a href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="msgBox('<?php echo U("Shop/receipt",array("id"=>$vo['oid'],"ajax"=>"1"));?>','GET','json','','<?php echo U("Shop/index",array("typeid"=>192));?>',true,'确定取水？');"><i class="fa fa-fw fa-truck"></i></a>
                                   <?php } ?>                          
