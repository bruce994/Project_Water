                ...
                <div class="box-header">
                  <h3 class="box-title">
                    <div style="float:left;margin:0 8px;">
                        <a href="<?php echo U("Member/addAddress");?>" class="btn btn-block btn-default"><i class="fa fa-fw fa-plus"></i>添加</a>
                    </div>
                  </h3>
                </div><!-- /.box-header -->
                ...
                <section id="no-more-tables">
                  <table id="example2" class="table-bordered table-striped table-condensed cf">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td data-title="收货地址"><?php echo ($vo["address"]); ?></td>
                        <td data-title="操作">
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="msgBox('<?php echo U("Member/deleteAddress",array("id"=>$vo['id'],"ajax"=>"1"));?>','GET','json','','<?php echo U("Member/address");?>',true,'确定删除？');"><i class="fa fa-fw fa-remove"></i></a>
                        </td>
