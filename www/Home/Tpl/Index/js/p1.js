		...
		function g() {
			var i = {
					...
					countdown: function(n, i, r, u, f, e, o, s, h, c, l, a) {
						var tt = this,
							rt = n.parents(".m-08-features-slide"),
							g = n.find(".countdown").empty(),
							nt = new Date,
							it, k, d, v;
						nt.setUTCFullYear(i, r - 1, u), nt.setUTCHours(f), nt.setUTCMinutes(e), nt.setUTCSeconds(0), it = (new Date).getTime(), v = nt - it, v = Math.floor(v / 1e3);
						...
						if (v > 0 && a === !1) v < 60 ? (y = this.stringLoop("###", y, '<div class="time"><div class="timewindow_upper"><\/div><div class="timewindow_lower"><\/div><span>###<\/span><\/div>'), p = this.stringLoop("###", p, '<div class="time"><div class="timewindow_upper"><\/div><div class="timewindow_lower"><\/div><span>###<\/span><\/div>'), b = this.stringLoop("###", b, '<div class="time"><div class="timewindow_upper"><\/div><div class="timewindow_lower"><\/div><span>###<\/span><\/div>'), g.append(y + '<div class="indication">' + s + '<\/div><div class="separation"><\/div>' + p + '<div class="indication">' + h + '<\/div><div class="separation"><\/div>' + b + '<div class="indication">' + c + "<\/div>")) : (w = this.stringLoop("###", w, '<div class="time"><div class="timewindow_upper"><\/div><div class="timewindow_lower"><\/div><span>###<\/span><\/div>'), y = this.stringLoop("###", y, '<div class="time"><div class="timewindow_upper"><\/div><div class="timewindow_lower"><\/div><span>###<\/span><\/div>'), p = this.stringLoop("###", p, '<div class="time"><div class="timewindow_upper"><\/div><div class="timewindow_lower"><\/div><span>###<\/span><\/div>'), g.append(w + '<div class="indication">' + o + '<\/div><div class="separation"><\/div>' + y + '<div class="indication">' + s + '<\/div><div class="separation"><\/div>' + p + '<div class="indication">' + h + "<\/div>")), n.show(), t.setTimeout(function() {
							...
							if (tt.updateStatus(n), d = new Date, d.setUTCFullYear(i, r - 1, u), d.setUTCHours(f), d.setUTCMinutes(e), d.setUTCSeconds(0), v = d - it, v = Math.floor(v / 1e3), v > 0) {
								var w = Math.floor(v / 86400),
									y = Math.floor(v / 3600 - w * 24),
									p = Math.floor(v / 60 - w * 1440 - y * 60) % 60,
									b = v - w * 86400 - y * 3600 - p * 60;
...
function(n, t, i) {
	...
	n(i).ready(function() {
		...
		if (!!$(".m-92-leasing-calculator-wrapper").length) {
			var f = $(".m-92-leasing-calculator-wrapper .slider-wrapper .sliderColumn"),
				a = f.length,
				r, k = !!$(".result .entity .summe").length,
				e = [],
				o = [],
				s = [],
				i = [],
				...
				d = $.get(leasingjsonurl, function(f) {
					var y, l;
					r = f.leasingdata, y = r.length;
					for (l in r) e.push(parseInt(r[l].term));
					for (l in r) o.push(parseInt(r[l].kilometers_per_annum));
					for (l in r) s.push(parseInt(r[l].deposit_in_percent));
					for (typeof leasingcalculator_term == "string" && leasingcalculator_term.length != 0 && typeof leasingcalculator_kilometers_per_annum == "string" && leasingcalculator_kilometers_per_annum.length != 0 && typeof leasingcalculator_deposit == "string" && leasingcalculator_deposit.length != 0 && (u = !0, h.push(leasingcalculator_term), h.push(leasingcalculator_kilometers_per_annum), h.push(leasingcalculator_deposit)), e = c(e), o = c(o), s = c(s), i.push(e), i.push(o), i.push(s), l = 0; l < a; l++) v(i, l);
					b(), t.search(r), u = !1, p(), $(".sliderColumn.deposit .text-rate-summe").text((new n).numberFormat(parseInt(t.arrDeposit[0].deposit), 3, ".")), $(".sliderColumn.deposit .slider-header span").eq(0).append("<br/>")
				}),
				v = function(n, t) {
					...
					r += '<div class="value_max"><div class="number">' + n[t][n[t].length - 1] + '<\/div><span class="point"><\/span><\/div>', f.eq(t).find(".slider-context").append(r), y(t, n[t].length - 1), w(t, n[t].length - 1)
				},
				y = function(e, o) {
					f.eq(e).find(".slider").slider({
						...
						slide: function(i, u) {
							l(e, u.value), t.search(r), $(".sliderColumn.deposit .text-rate-summe").text((new n).numberFormat(parseInt(t.arrDeposit[0].deposit), 3, "."))
						}
					}), l(e, i[e][0])
				},
				p = function() {
				...
				w = function(n, t) {
					t >= 2 && (f.eq(n).find(".value_min").css("width", 100 / t + "%"), f.eq(n).find(".value").css("width", 100 / t + "%"))
				},
				b = function() {
	...
	function(n, t, i, r) {
		...
		function f(t) {
			t.parent().addClass("m-15-touch-disabled"), t.find("select").prop("disabled", !0).select2("enable", !1), n(".m-15-go-wrapper>a").addClass("m-15-disabled").removeAttr("href")
		}

		function e(n) {
			n.parent().removeClass("m-15-touch-disabled"), n.find("select").prop("disabled", !1).select2("enable", !0)
		}

		function o() {
			var t, i;
			Modernizr.touch ? n("#m-15-dd-country > select").val(n("#m-15-dd-country > select").data("placeholder")) : n("#m-15-dd-country > select").select2("data", null), t = n("#m-15-dd-continent > select > option:selected"), t.prop("disabled") ? f(n("#m-15-dd-country")) : (n("#m-15-dd-country > select").children("option:not(:first)").remove(), i = n.grep(u, function(n) {
				return n.title == t.attr("value")
			}), n("#m-15-dd-country > select").append(i[0].innerHTML), e(n("#m-15-dd-country")), n("#m-15-dd-country > select").unbind("change").change(s))
		}

		function s() {
			var t = n("#m-15-dd-country > select > option:selected");
			if (Modernizr.touch && t.prop("disabled")) n(".m-15-go-wrapper>a").addClass("m-15-disabled");
		...
		n(i).ready(function() {
			...
			Modernizr.touch && (t.find("option:first").html(t.data("placeholder")).prop("disabled", !0), i.find("option:first").html(i.data("placeholder")).prop("disabled", !0), n("#m-15-dd-country").parent().addClass("m-15-touch-disabled"), t.val(t.data("placeholder")), i.val(i.data("placeholder"))), u = i.children("optgroup").remove(), t.change(o)
		})
	}(jQuery, this, this.document),
	function(n, t, i, r, u) {
		"use strict";
		n(i).ready(function() {
			...
			var t = u,
				n;
			r.debug = !0, n = new r.Interface(".stry-widget-grid", {
