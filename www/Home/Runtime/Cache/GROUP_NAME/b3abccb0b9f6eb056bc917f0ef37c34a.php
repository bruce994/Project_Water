...
</script><!--END comment--><div class="clear"></div></div><div class="detail-img"><h2 class="title"><span>图文详情</span></h2><div><?php echo ($vo["body"]); ?></div></div></div><a href="javascript:void(0);" data-aid="<?php echo ($vo["id"]); ?>"  data-channel="<?php echo ($vo["channel"]); ?>"  data-typeid="<?php echo ($vo["typeid"]); ?>" class="dh exchange">立即兑换</a><script>  var mySwiper1 = new Swiper ('.swiper2', {
    loop: true,
                  ...
                  bootbox.dialog({
                    ...
                    buttons: {
                     ...
                     main: {
                          ...
                          className: "btn-primary",
                          callback: function() {
                            location.href = "/andMember<?php echo U("Shop/index",array("ss"=>2));?>";
                          }
                        }
