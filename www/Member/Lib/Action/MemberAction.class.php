...
$this->assign ( 'totalPages', $p->totalPages );
     ...
     public function payUrl(){
        ...
        switch ($code) {
            case 'alipay':
                header('Location: '.C('site_url').'/Member/Pay/bank/alipayapi.php?WIDout_trade_no='.$operation['buyid'].'&WIDsubject='.$operation['pname'].'&WIDtotal_fee='.$operation['money'].'&paytype='.$code);
                break;
