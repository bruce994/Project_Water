          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <form action="<?php echo U("Admin/ad",array("ss"=>6));?>" method="get">
                <div class="box-header">
                    <div style="float:left;margin:0 8px;">
                      <a href="<?php echo U("Admin/addAd",array("ss"=>6));?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                    </div>
                    <div style="float:left;">
                      <a href="#" id="ids0" class="btn btn-block btn-default btn-sm" onclick="action('deleteAd&id=','ids0');"> <i class="fa fa-fw fa-remove"></i>
                       删 除
                     </a>
                     </div>
                     <div class="box-tools">
                        <div class="input-group" style="width: 150px;">
                          <input type="text" name="q" class="form-control input-sm pull-right" placeholder="<?php echo empty($_GET['q'])?"按广告名搜索":$_GET['q'];?>">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td><?php echo ($vo["adname"]); ?><br/><?php echo ($vo["subtitle"]); ?></td>
                             <td>
                                <?php echo (date("Y-m-d H:i",$vo['starttime'])); ?></td>
                             <td>
                                <?php echo (date("Y-m-d H:i",$vo['endtime'])); ?></td>
                              <td>
                                 <img src="<?php echo ($vo["image"]); ?>" width="180" height="60" />
                              </td>                              
                              <td>
                                 <?php echo ($vo["score"]); ?>
                              </td>
                              <td><?php echo ($vo["limit_n"]); ?></td>
                              <td>
                                <a title="编辑" href="<?php echo U("Admin/editAd",array("id"=>$vo['id'],"ss"=>6));?>"><i class="fa fa-fw fa-edit"></i></a> | <a href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo U("Admin/deleteAd",array("id"=>$vo['id']));?>');"><i class="fa fa-fw fa-remove"></i></a>
                              </td>
