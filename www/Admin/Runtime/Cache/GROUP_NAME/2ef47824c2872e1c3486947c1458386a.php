                ...
                <form role="form" method="post" id="form1" action="<?php echo U("Member/update");?>" class="pageForm required-validate">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>邮箱</label>
                      <input type="text" name="email"  value="<?php echo ($vo["email"]); ?>" class="form-control required">
                    </div>

                    <div class="form-group">
                      <label>真实姓名</label>
                      <input type="text" name="uname"  value="<?php echo ($vo["uname"]); ?>" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                      <label>姓别：</label>
                       <label>
                         ...
                         <input class="minimal-red" type="radio" value = "保密" name="sex" <?php if(($vo1["sex"]) == "保密"): ?>checked<?php endif; ?> >保密
                      </label>
                    </div>
                    ...
                    <div class="form-group">
                      <label>电话</label>
                      <input type="text" name="tel"  value="<?php echo ($vo1["tel"]); ?>" class="form-control">
                    </div>

                    <div class="form-group">
                      <label>地址</label>
                      <input type="text" name="address"  value="<?php echo ($vo1["address"]); ?>" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                      <label>积分</label>
                      <input type="text" name="scores"  value="<?php echo ($vo["scores"]); ?>" class="form-control number">
                    </div>
