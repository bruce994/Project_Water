          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <form action="<?php echo U("Member/notice",array("ss"=>2));?>" method="get">
                <div class="box-header">
                    <div style="float:left;margin:0 8px;">
                      <a href="<?php echo U("Member/noticeAdd",array("ss"=>2));?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                    </div>
                    <div style="float:left;">
                      <a href="#" id="ids0" class="btn btn-block btn-default btn-sm" onclick="action('noticeDelete&id=','ids0');"> <i class="fa fa-fw fa-remove"></i>
                       删 除
                     </a>
                     </div>
                     <div class="box-tools">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo['title']); ?></td>
                             <td>
                              ...
                              <td>
                                <a title="编辑" href="<?php echo U("Member/noticeEdit",array("id"=>$vo['id'],"ss"=>2));?>"><i class="fa fa-fw fa-edit"></i></a> | <a data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo U("Member/noticeDelete",array("id"=>$vo['id']));?>');" onclick="return window.confirm('确定删除？');" title="删除"><i class="fa fa-fw fa-remove"></i></a>
                              </td>
