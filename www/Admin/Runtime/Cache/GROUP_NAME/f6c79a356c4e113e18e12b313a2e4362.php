          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <form action="<?php echo U("Shop/index",array("ss"=>2));?>" method="get">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td>
                              <input name="id" value="<?php echo ($vo["oid"]); ?>" type="checkbox" onclick="addids(this)"></td>
                             ...
                             <td>
                              ...
                              <td>
                                  ...
                                  <?php if(($vo["state"]) == "1"): if(($vo["paytype"]) == "1"): ?><span class="badge bg-light-blue"><i class="fa fa-fw fa-qrcode"></i>二维码</span><?php endif; ?>
                                   <?php if(($vo["paytype"]) == "1"): ?><span class="badge bg-green"><i class="fa fa-fw fa-credit-card"></i>刷卡</span><?php endif; endif; ?>
                              </td>                              
                              
                              <td>
                                <?php
 $member = M("Member")->where("mid=".$vo['mid'])->field("userid")->find(); echo $member['userid']; ?>
                              </td>

                              <td>
                                  <?php
 $tmp1 = explode(",","193".getType2("193")); ?>
                                  <?php  if(in_array($vo['typeid'],$tmp1 )){ ?>
                               ...
                               <td>
                                   ...
                                   <?php
 $address = M("Shops_userinfo")->where("mid=".$_SESSION["member"]['mid'])->field("address")->find(); if(!empty($address)){ echo $address['address']; } ?>
                                   </p>
                                   <p>
                                       <button class="btn btn-block btn-primary btn-sm" data-toggle="modal" data-target="#myModalProduct<?php echo ($vo["id"]); ?>">点击更新发货状态</button>
                                       <div id="myModalProduct<?php echo ($vo["id"]); ?>" class="modal fade" tabindex="-1" role="dialog">
                                           <div class="modal-dialog modal-sm" role="document">
                                               <form action="<?php echo U("Shop/changeStatus",array("id"=>$vo['oid'],"ss"=>2));?>" method="get">
                                                   <div class="modal-content">
                                                       <div class="modal-body" style="text-align:center;">
                                                           <div class="form-group">
                                                               <label>更新发货状态</label>
                                                               <select name="state" class="form-control">
                                                                   <option value="0" <?php if(($vo["state"]) == "0"): ?>selected = "selected"<?php endif; ?> >未发货</option><option value="1"  <?php if(($vo["state"]) == "1"): ?>selected = "selected"<?php endif; ?>  >已发货</option>                      
                                                               </select>
                                                           </div>
                                                       </div>
                              ...
                              <td>
                                ...
                                <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal<?php echo ($vo["id"]); ?>"><i class="fa fa-fw fa-qrcode"></i></a>    
                          ...
                          <?php
 $url = C('site_url').U('Home/Index/index', array('id' => $vo['id'])); $url = str_replace("Member", "Home", $url); ?>
                          <!--dialog-->
