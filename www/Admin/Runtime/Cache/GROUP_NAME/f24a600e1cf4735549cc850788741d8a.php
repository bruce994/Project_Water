          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" id="form1" action="<?php echo U("Admin/updateAd");?>" class="pageForm required-validate">
                  <input type="hidden" name="id" value="<?php echo ($vo["id"]); ?>" >
                  <div class="box-body">

                    <div class="form-group">
                      <label>广告名称</label>
                      <input type="text" name="adname" value="<?php echo ($vo["adname"]); ?>"  class="form-control required">
                    </div>
                    
                    <div class="form-group">
                      <label>广告副标题名称</label>
                      <input type="text" name="subtitle"   value="<?php echo ($vo["subtitle"]); ?>" class="form-control ">
                    </div>
                    ...
                    <div class="form-group">
                      <label>广告图片</label>
                      <div class="input-group">
                        <input type="text" id="image" name="image" class="form-control required" value="<?php echo ($vo["image"]); ?>">
                        <span class="input-group-addon"><a href="javascript:void();" onclick="upyunPicUpload('image')"><i class="fa fa-fw fa-upload"></i>点击上传</a></span>
                        <span class="input-group-addon"><a href="javascript:void();" onclick="viewImg('image')"><i class="fa fa-fw fa-share"></i>预览</a></span>
                      </div>
                    </div>  
                    ...
                    <div class="form-group">
                      <label>点击打开链接</label>
                      <input type="text" name="url" value="<?php echo ($vo["url"]); ?>"  class="form-control">
                    </div>
                 ...
                 <!-- Date range -->
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pull-right" id="starttime" name="starttime" value="<?php echo date("Y-m-d H:i",$vo['starttime']); ?>">
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                 ...
                 <!-- Date range -->
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pull-right" id="endtime" name="endtime" value="<?php echo date("Y-m-d H:i",$vo['endtime']); ?>">
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                    ...
                    <div class="form-group">
                      <label>点击次数送积分/次</label>
                      <input type="text" name="score"  value="<?php echo ($vo["score"]); ?>" class="form-control required number">
                    </div>

                    <div class="form-group">
                      <label>每天限制次数</label>
                      <input type="text" name="limit_n"  value="<?php echo ($vo["limit_n"]); ?>" class="form-control required number">
                    </div>
  ...
  <link rel="stylesheet" href="__PUBLIC__/plugins/daterangepicker/daterangepicker-bs3.css">
    <script>
      $(function () {
        ...
        $('#starttime').daterangepicker({singleDatePicker: true, timePickerIncrement: 1,timePicker: true,timePicker12Hour:false, format: 'YYYY-MM-DD HH:mm'});
        $('#endtime').daterangepicker({singleDatePicker: true, timePickerIncrement: 1,timePicker: true,timePicker12Hour:false, format: 'YYYY-MM-DD HH:mm'});
      });
    </script>
