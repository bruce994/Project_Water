          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-header">
                  <h3 class="box-title">
                    <a href="<?php echo U("Type/add",array("ss"=>3));?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                  </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php  $typeid = $_SESSION["admin"]['typeid']; echo getJG2($typeid); ?>
                    </tbody>
                  </table>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
